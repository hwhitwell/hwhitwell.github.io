...
if (isset($_POST['name']) AND isset($_POST['email']) AND isset($_POST['ticket']) AND isset($_POST['message']))
{    
    // Collect POST data from form
    $name = $security->xss_clean($_POST['name']);
    $email = $security->xss_clean($_POST['email']);
    $ticket = $security->xss_clean($_POST['ticket']);
    $message = $security->xss_clean($_POST['message']);
    
    // Prefedined Variables  
    $set_from = 'Dione Notification Mailer';
    $subject = 'Dione: Event Ticket Form Details';
    ...
    <tr><td valign="top">Ticket:</td><td>' . $ticket . '</td></tr>
